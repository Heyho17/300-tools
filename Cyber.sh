...
#MALU TOLOL!!!
#KAGA BERMORAL!
#GUA SUMPAHIN YG RECORD COPYRIGHT
#BISUL GK SEMBUH SEMBUH :V
#AAMIIN
...
echo [•]"TOTALS    : 312 TOOLS                                     [•]" | lolcat
echo [•]"AUTHOR    : MR.HEYHO                                      [•]" | lolcat
echo [•]"YOUTUBE   : @HEYHO-CYBER                                  [•]" | lolcat
...
echo -e "============================" | lolcat
echo -e $b "312. Install SMS-Wa-v0.2${enda}";
echo -e "============================"
echo -e $b "00. Exit${enda}";
echo -e "============================" | lolcat
echo -e "╭─[PILIH NOMORNYA]"
read -p "   ╰─root@./MR.HEYHO=" pil;
...
echo -e "${y} bash CBC1.sh"
echo -e "${y} USERNAME:Heyho"
echo -e "${y} PASWORD:Heyho17"

;;

00) echo "AUTHOR: MR.HEYHO" | lolcat
echo "MR.HEYHO ON YOUR SYSTEM" | lolcat
echo "CLASSY BASTARD CYBER" | lolcat
echo "KABEH TOOLS NU SIA INSTALL AYA DI DIRECTORY TOOLS AINK" | lolcat
figlet MR.HEYHO | lolcat
exit
;;
